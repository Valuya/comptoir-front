...
import {filter, map, publishReplay, refCount, scan, switchMap, take, tap, throwIfEmpty} from 'rxjs/operators';
...
export class ComptoirSaleService {
  ...
  addVariant$(ref: WsItemVariantRef): Observable<WsItemVariantSaleRef> {
