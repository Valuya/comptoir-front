...
import {NgFor, NgIf, NgSwitch, NgSwitchWhen, DatePipe} from 'angular2/common';

import {ItemVariantStock, StockChangeType} from '../../../client/domain/itemVariantStock';
...
export class ItemVariantStockColumnComponent {
    ...
    onColumnAction(itemVariantStock:ItemVariantStock, column:ItemVariantStockColumn, event) {
        this.action.emit({itemVariantStock: ItemVariantStock, column: column});
...
export class ItemVariantStockList {
    ...
    onItemVariantStockClick(item:ItemVariantStock, event) {
