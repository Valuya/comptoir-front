...
import {ItemVariantListComponent, ItemVariantColumn} from "../list/itemVariantList";
import {ItemListComponent, ItemColumn} from "../../item/list/itemList";
...
@Component({
    selector: 'itemvariant-select',
    changeDetection: ChangeDetectionStrategy.Default,
    templateUrl: './components/itemVariant/select/itemVariantSelect.html',
    styleUrls: ['./components/itemVariant/select/itemVariantSelect.css'],
    directives: [NgFor, NgIf, ItemListComponent, ItemVariantListComponent]
})

export class ItemVariantSelectComponent implements AfterViewInit {
